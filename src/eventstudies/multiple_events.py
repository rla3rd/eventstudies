...
log = logging.getLogger('eventstudies.multiple_events')
...
class MultipleEvents:
    ...
    and its significance tests. This class takes in input a list of single
    event studies (`eventstudies.SingleEvent`) aggregates them and returns
    aggregate statistics and tests.
    ...
    def __init__(
        ...
        ----------
        sample : list
            List containing `eventstudies.SingleEvent` objects. 
            You can run independently each event study, aggregate 
            them in a dictionary and compute their aggregate statistics.
        errors : list, optional
            A list containing errors encountered during the computation of
            single event studies, by default None.
        See also
        -------
        ...
        >>> es.SingleEvent.import_returns(cached=True)
        ...
        ...     )
        ...     event = es.SingleEvent.MarketModel(
        ...         ticker='AAPL',
        ...         mkt_idx='SPY',
        ...
        self.win_size = sample[0].win_size
        self.sample = sample
    ...
    def results(self, asterisks: bool = True, decimals=4):
        ...
        asterisks : bool, optional
            Add asterisks to CAR value based on significance of p-value,
            by default True
        ...
        columns = {
            "AAR": self.AAR,
            "StdErr AAR": np.sqrt(self.var_AAR),
            "CAAR": self.CAAR,
            "StdErr CAAR": np.sqrt(self.var_CAAR),
            "T-stat": self.tstat,
            "P-value": self.pvalue
        }
        ...
        asterisks_dict = {
            "pvalue": "P-value",
            "where": "CAAR"} if asterisks else None
    ...
    def plot(self, *, AAR=False, CI=True, confidence=0.90):
        ...
        You can extend the figure and apply new set-up with matplolib's method
        (e.g. savefig).
        
        Example
        -------
        Plot CAR (in blue) and AR (in black), with a confidence interval of 95%
        (in grey).
        >>> events = es.MultipleEvents.from_csv(
        ...     'AAPL_10K.csv',
        ...     es.SingleEvent.FamaFrench3,
    ...
    def get_CAR_dist(self, decimals=4):
        """
    ...
    def from_list(
        ...
        *,
        ...
        ignore_errors : bool, optional
            ...
            using `print(eventstudies.MultipleEvents.error_report())`. 
        ...
        -------
        >>> list = [
        ...     {'event_date': np.datetime64("2018-11-05"), 'ticker': 'AAPL'},
        ...     {'event_date': np.datetime64("2017-11-03"), 'ticker': 'AAPL'},
        ...     {'event_date': np.datetime64("2016-10-26"), 'ticker': 'AAPL'},
        ...     {'event_date': np.datetime64("2015-10-28"), 'ticker': 'AAPL'},
        ... ]
        >>> agg = eventstudies.MultipleEvents.from_list(
        ...     event_list = list,
        ...     event_model = eventstudies.SingleEvent.FamaFrench3,
        ...     event_window = (-5,+10),
        ... ) 
        """
        ...
        event_param_keys = ('ticker', 'event_date', 'mkt_idx')
    ...
    def from_csv(
        ...
        *,
        ...
        Example
        -------
        >>> agg = eventstudies.MultipleEvents.from_csv(
        ...     path = 'events.csv',
    ...
    def from_excel(
        ...
        *,
        ...
        Example
        -------
        >>> agg = eventstudies.MultipleEvents.from_excel(
        ...     path = 'events.xlsx',
        ...     event_model = eventstudies.SingleEvent.MarketModel,
        ...     event_window = (-5,+10),
        ...     date_format = "%d/%m/%Y"
    ...
    def from_pandas(
        ...
        *,
        ...
        Example
        -------
        >>> agg = eventstudies.MultipleEvents.from_pandas(
        ...     df,
        ...     event_model = eventstudies.SingleEvent.MarketModel,
        ...     event_window = (-5,+10)
        ... )
