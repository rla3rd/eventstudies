...
project = 'Event Studies'
copyright = f'2024, {es.__author__}, GNU General Public License v3 (GPLv3)'
...
github_doc_root = "https://github.com/rla3rd/eventstudies/tree/main/eventstudies/docs-src/source"
